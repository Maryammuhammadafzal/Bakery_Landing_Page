  ...
  let blog_data = [
    {
      ...
      description: "Ever wondered why sourdough is all the rage? Dive into the fascinating world of sourdough and learn how we achieve that perfectly crisp crust and airy interior.",
      image: BlogImage1.src,
    },
    {
      title: "Baking for the Holidays: Festive Treat Ideas.",
      description: "The holidays are around the corner, and it’s time to deck the table with treats! Discover our favorite holiday recipes and pro tips for making your celebrations extra sweet.",
      image: BlogImage2.src,
    },
    {
      title: "5 Baking Mistakes You Didn’t Know You Were Making.",
      description: "From overmixing to improper measuring, these common errors could be sabotaging your baked goods. Learn how to avoid them and elevate your baking game.",
