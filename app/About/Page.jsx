...
const AboutPage = () => {
  return (
    <div className="flex h-auto py-16 justify-center items-center">
      <div className="flex gap-5 md:flex-row flex-col justify-center items-center h-auto w-full">
        <div className="left pl-24 flex flex-col h-auto md:w-[55%] w-full gap-4 md:items-start items-center justify-center">
        ...
        <div className="right flex pl-6 h-auto md:w-[45%] w-full items-center justify-center">
          <Image
            width={430}
            height={100}
            src={AboutImage}
            alt="icon"
            className="rounded-lg w-full h-[500px] object-cover object-bottom-left"
          />
        </div>
      </div>
    </div>
